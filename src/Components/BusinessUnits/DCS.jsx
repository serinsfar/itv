...
const dcsFeatures = [
    ...
    },
    {
      ...
      description: 'Automated evaluation to determine if an object constitutes an air navigation obstacle.',
    },
    {
    ...
    return (
        ...
        <div className="pt-10 container pl-45 col-start-2 col-span-5">
          ...
          <p className="text-gray-600 leading-relaxed max-w-4xl">
            We offer comprehensive support for stakeholders engaging with the DCS platform. Our services include assistance with obstacle registration, guidance on compliance requirements, and training on effective use of the DCS portal. By partnering with us, you ensure that your aeronautical data submissions are accurate, timely, and fully compliant with FOCA regulations.
          </p>
        </div>
      </div>
    );
