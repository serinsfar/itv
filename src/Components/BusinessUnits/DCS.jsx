...
const dcsFeatures = [
  {
    ...
    description: 'Seamless digital delivery and handling of aeronautical data, including obstacles' +
        '.'
  }, {
    icon: <FaMapMarkedAlt className="text-secondary text-2xl"/>,
    title: 'Obstacle Assessment',
    description: 'Automated evaluation to determine if an object constitutes an air navigation obs' +
        'tacle.'
  }, {
    icon: <FaShieldAlt className="text-secondary text-2xl"/>,
    title: 'Regulatory Compliance',
    description: 'Ensures adherence to FOCA regulations for obstacle registration and approval.'
  }, {
    icon: <FaTools className="text-secondary text-2xl"/>,
    title: 'User-Friendly Portal',
    description: 'Intuitive interface for registering and managing obstacle data efficiently.'
  }
];

const dcsBenefits = ['Streamlined process for obstacle registration and approval', 'Enhanced data accuracy and consistency', 'Improved aviation safety through up-to-date obstacle information', 'Reduced administrative burden for stakeholders'];
      ...
      <div className="pt-10 container pl-45 col-start-2 col-span-5">
        ...
        <div className="grid xl:grid-cols-2 gap-8 place-items-center py-10">
          ...
          <div className="mb:pl-12">
            ...
            <p>
              The Data Collection Service (DCS) is a digital platform operated by ITV Consult
              AG on behalf of the Swiss Federal Office of Civil Aviation (FOCA). It
              facilitates the efficient submission and management of aeronautical data,
              particularly concerning air navigation obstacles. By leveraging modern
              technology, DCS enhances data quality and ensures compliance with aviation
              safety regulations.
            </p>
          </div>
        </div>
        ...
        <p className="text-gray-600 leading-relaxed max-w-4xl">
          We offer comprehensive support for stakeholders engaging with the DCS platform.
          Our services include assistance with obstacle registration, guidance on
          compliance requirements, and training on effective use of the DCS portal. By
          partnering with us, you ensure that your aeronautical data submissions are
          accurate, timely, and fully compliant with FOCA regulations.
        </p>
      </div>
    </div>
  );
